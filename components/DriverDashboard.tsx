...
const DriverDashboard: React.FC<DriverDashboardProps> = ({ driver, bus, route, onEmergency, onLogout }) => {
  return (
    <div className="flex flex-col h-full bg-slate-50 overflow-y-auto no-scrollbar pb-24 lg:pb-28 lg:pt-4">
      <div className="flex-1 w-full max-w-2xl mx-auto flex flex-col bg-white lg:shadow-xl lg:rounded-3xl lg:border lg:border-slate-150 overflow-hidden">
        {/* Profile Header */}
