...
// Use body-parsers with 15MB limit to support base64 imagery uploads for analysis
...
// For local testing of this handler directly in Vercel Dev command if needed
app.get("/api/health", (req, res) => {
  res.json({ status: "healthy", service: "Vercel Serverless Function" });
});
